...
function HeroBanner() {
  return (
    <div className="mb-10">
      <Breadcrumb className="text-[#667479] text-sm font-medium mb-5">
        <BreadcrumbList>
          <BreadcrumbItem>
   ...
   <div className="hidden md:flex items-center  w-full px-20 relative  h-[400px]">
    <div className="z-10  w-full mt-[101px]  ">
        <img src="/bigDogImage.png" alt="dogs" className="w-full  h-[300px]" />
    </div>
    <div className="relative z-10  flex flex-col items-end justify-end w-full  text-white">
      <h1 className="text-[4vw] leading-[68px] font-extrabold whitespace-nowrap">One More Friend</h1>
      <p className="mt-2 font-bold text-[2vw] leading-[54px]">Thousands More Fun!</p>
      <p className="mt-4 text-xs max-w-md text-[#CCD1D2] text-end">
      ...
      <div className="flex flex-col md:hidden">
        ...
        <div className=" bg-[#FFF7E2] -z-10 absolute h-80 w-full rounded-t-[20px] "></div>
          <div className="relative p-6">
            <h2 className="text-3xl font-extrabold text-[#002A48]">One More Friend</h2>
            <p className="text-2xl font-semibold">
              Thousands More Fun!{" "}
              <span className="inline-block w-2 h-2 bg-[#00171F] rounded-full ml-2"></span>
            </p>
            <p className="mt-3 text-xs text-[#242B33] leading-relaxed">
