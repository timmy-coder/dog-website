  ...
  return (
    <footer className="py-10 -mx-5 px-5 xl:-mx-20 xl:px-20 bg-[linear-gradient(180deg,#FCEED5,#FCEED5,#FFE7BA)] rounded-t-[20px]">
        ...
        <div className="flex flex-col xl:flex-row xl:items-start xl:justify-between items-center justify-center gap-[20px] border-b border-[#CCD1D2] pb-10">
            <ul className="text-[#00171F] text-base flex items-center justify-center gap-[40px]">
        ...
        <div className="text-[#667479] text-[12px]  leading-[18px] font-medium flex items-center gap-10">
            <p>Terms of Service</p>
            <p>Privacy Policy</p>
        </div>
        <Image src={Logo} className="hidden xl:block" width={114} height={26} alt="Logo icon"/>
        <p className="text-[#667479] font-normal text-[10px] leading-[16px]">© 2022 Monito. All rights reserved.</p>
