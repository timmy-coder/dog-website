  ...
  return (
    <header>
      ...
      <nav className="hidden xl:flex items-center justify-between my-8">
        ...
        <ul className="text-[#00171F] text-base flex font-bold font-[GilroyBold] gap-[40px]">
            <li>
              <Link href={"#"}>Home</Link>
            </li>
            <li>
        ...
        <div className="flex items-center gap-20">     
          <div className="flex items-center gap-[12px] py-[12px] pr-[20px] pl-[16px]">
            ...
            <input
              ...
              name="search"
              id="search"
              className="outline-none font-medium font-[GilroyMedium]   text-sm text-[#99A2A5]"
            />
          </div>
          <div className="flex items-center gap-5">
          <button
            type="button"
            className="bg-[#003459] text-white cursor-pointer pt-[14px] pb-[10px] px-[28px] rounded-[57px] text-xl font-bold font-[GilroyBold]"
          >
            Join the community{" "}
          </button>
          ...
          <button className="text-[#002A48] flex items-center gap-[4px] ">
            ...
            <span className="font-medium font-[GilroyMedium] text-base">VND</span>
            <ChevronDown size={20} />
          </button>
        </div>
        </div>
